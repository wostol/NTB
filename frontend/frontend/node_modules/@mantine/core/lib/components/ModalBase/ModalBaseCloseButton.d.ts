...
export declare function ModalBaseCloseButton({ className, onClick, ...others }: ModalBaseCloseButtonProps): import("react/jsx-runtime").JSX.Element;
export declare namespace ModalBaseCloseButton {
