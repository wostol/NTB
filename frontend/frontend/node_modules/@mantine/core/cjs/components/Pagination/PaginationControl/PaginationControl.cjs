...
//#region packages/@mantine/core/src/components/Pagination/PaginationControl/PaginationControl.tsx
const defaultProps = { withPadding: true };
const PaginationControl = require_factory.factory((_props) => {
	const { classNames, className, style, styles, vars, active, disabled, withPadding, mod, ...others } = require_use_props.useProps("PaginationControl", defaultProps, _props);
...
PaginationControl.classes = require_Pagination_module.default;
