...
const require_RadioCard_module = require("./RadioCard.module.cjs");
let react = require("react");
let react_jsx_runtime = require("react/jsx-runtime");
//#region packages/@mantine/core/src/components/Radio/RadioCard/RadioCard.tsx
const RadioCardContext = (0, react.createContext)(null);
...
const RadioCard = require_factory.factory((_props) => {
	const props = require_use_props.useProps("RadioCard", defaultProps, _props);
	...
	const getStyles = require_use_styles.useStyles({
		name: "RadioCard",
		classes: require_RadioCard_module.default,
		props,
		className,
		style,
		classNames,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RadioCardContext, {
...
RadioCard.classes = require_RadioCard_module.default;
