...
const ComboboxOptions = require_factory.factory((_props) => {
	const { classNames, className, style, styles, id, onMouseDown, labelledBy, ...others } = require_use_props.useProps("ComboboxOptions", null, _props);
...
ComboboxOptions.classes = require_Combobox_module.default;
