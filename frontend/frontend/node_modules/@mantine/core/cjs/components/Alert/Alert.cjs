...
//#region packages/@mantine/core/src/components/Alert/Alert.tsx
...
const Alert = require_factory.factory((_props) => {
	const props = require_use_props.useProps("Alert", null, _props);
	...
	const rootId = (0, _mantine_hooks.useId)(id);
...
Alert.classes = require_Alert_module.default;
