...
//#region packages/@mantine/core/src/components/Tabs/TabsList/TabsList.tsx
const TabsList = require_factory.factory((_props) => {
	const props = require_use_props.useProps("TabsList", null, _props);
...
TabsList.classes = require_Tabs_module.default;
